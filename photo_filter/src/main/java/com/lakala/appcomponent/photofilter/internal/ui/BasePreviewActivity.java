...
import com.lakala.appcomponent.photofilter.internal.entity.IncapableCause;
...
import com.lakala.appcomponent.photofilter.internal.ui.widget.CheckView;
...
//                    ((PreviewItemFragment) mAdapter.instantiateItem(mPager, mPreviousPos)).clearColorFilter();
                } else {
...
//                    ((PreviewItemFragment) mAdapter.instantiateItem(mPager, mPreviousPos)).setColorFilter();
                }
                updateApplyButton();
...
//                    ((PreviewItemFragment) adapter.instantiateItem(mPager, position)).setColorFilter();
                } else {
