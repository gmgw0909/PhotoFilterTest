...
import com.lakala.appcomponent.photofilter.internal.ui.widget.MediaGridInset;
import com.lakala.appcomponent.photofilter.internal.utils.UIUtils;
...
public class MediaSelectionFragment extends Fragment implements
    ...
    public void getFirstItem() {//拍照返回 默认选择中
        mAdapter.getCursor().moveToPosition(1);
        mSelectionProvider.provideSelectedItemCollection().add(Item.valueOf(mAdapter.getCursor()));
    }
