...
public class FilterDataSet {
    public static List<FilterInfo> filters = new ArrayList<>();
    ...
    public static List<Bitmap> getSmallPic(Context context, Bitmap bitmap) {
        ...
        for (FilterInfo effect : FilterDataSet.filters) {
            gpuImage.deleteImage();
            GPUImageFilter filter = createFilterForType(context, effect.type);
